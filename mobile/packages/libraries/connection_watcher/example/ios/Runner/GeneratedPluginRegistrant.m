...
#if __has_include(<connection_watcher/ConnectionWatcherPlugin.h>)
#import <connection_watcher/ConnectionWatcherPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  [ConnectionWatcherPlugin registerWithRegistrar:[registry registrarForPlugin:@"ConnectionWatcherPlugin"]];
